...
private:
   ...
   bool insert_to_tree(TreeNode*,TreeNode*);
   //find helper function
   DBentry* find_helper(TreeNode*, int&, string);
   //remove helper function
   TreeNode* find_parent_node(DBentry*,TreeNode*);
   TreeNode* find_rightmost(TreeNode*);
   ///count active helper
   void count_helper(TreeNode*, int&)const;
public:
